...
// ⚠️ UNCONFIRMED: Simplified state annotation based on LangGraph docs
// This is a simplified version that may need adjustment based on actual LangGraph requirements
export const GameStateAnnotation = Annotation.Root({
  ...
  // Waidrin-specific properties (simplified for now)
...
// Note: GameState type is already defined above from GameStateAnnotation
